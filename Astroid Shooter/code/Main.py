...
# ship import
ship_surf = pygame.image.load('Astroid Shooter/graphics/ship.png').convert_alpha()
ship_rect = ship_surf.get_rect(center = (WINDOW_WIDTH / 2,WINDOW_HEIGHT / 2))

# background 
bg_surf = pygame.image.load('Astroid Shooter/graphics/background.png').convert()

# laser import
laser_surf = pygame.image.load('Astroid Shooter/graphics/laser.png').convert_alpha()
laser_list = []
...
# import text 
font = pygame.font.Font('Astroid Shooter/graphics/subatomic.ttf', 50)

# meteor
meteor_surf = pygame.image.load('Astroid Shooter/graphics/meteor.png').convert_alpha()
meteor_list = []
...
# import sound
laser_sound = pygame.mixer.Sound('Astroid Shooter/sounds/laser.ogg')
explosion_sound = pygame.mixer.Sound('Astroid Shooter/sounds/explosion.wav')
background_music = pygame.mixer.Sound('Astroid Shooter/sounds/music.wav')
